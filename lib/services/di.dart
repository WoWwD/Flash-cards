...
import '../presentation/provider/collection_cards_model.dart';
...
Future<void> init() async {
  ...
  getIt.registerLazySingleton(() => CollectionCardsModel(collectionLocalRepository: collectionLocalRepository));
